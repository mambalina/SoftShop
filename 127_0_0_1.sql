...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 05 2019 г., 00:53
...
INSERT INTO `good` (`id`, `provider_id`, `price`, `preview`, `name`, `category_id`, `description`) VALUES
(1, 1, 1230, 'her.jpg', 'Falcon DB2714', 2, 'Удобны при ношении. Прорезиненный низ подошвы для лучшего сохранения'),
(3, 2, 935, 'NewBalance501AthleticShoe4.jpg', 'Athletic Shoe', 2, ' Внутри такой обуви стопы равномерно дышат, чему способствуют продуманные вставки для отвода тепла и влаги.'),
(6, 3, 890, 'PUMAxBTSBasketPatentSneakers.jpg', 'Basket Patent', 1, 'Отличный выбор для тех, кто любит качество и удобство'),
(7, 1, 1530, 'SharksхNikanorYarmin2.jpg', 'Sharks Nikanor Yarmin', 1, 'Выбор номер 1 среди молодёжи!'),
(8, 5, 999, 'Vans_Classic_Old_Skool_Custom_Rose_2.jpg', 'Old Skool Custom Rose', 2, 'Удобная и качественная кастомная модель кед');
...
(6, 1, 'img/OriginalsFalcon1.jpg'),
(7, 1, 'img/OriginalsFalcon2.jpg'),
(8, 1, 'img/OriginalsFalcon3.jpg'),
(9, 1, 'img/OriginalsFalcon4.jpg'),
...
(21, 7, 'img/SharksхNikanorYarmin2.jpg'),
...
ALTER TABLE `good`
  ...
  ADD CONSTRAINT `good_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
